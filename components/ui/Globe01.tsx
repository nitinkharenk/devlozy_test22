    ...
    <div className="flex flex-row items-center justify-center py-20 h-screen md:h-auto dark:bg-black bg-black relative w-full">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4">
        <motion.div
          ...
          className="div"
        >
          <h2 className="text-start text-xl md:text-2xl font-bold text-white dark:text-white mx-20">
          Around The World
          </h2>
          <p className="text-start text-base md:text-md font-normal text-white dark:text-neutral-200 max-w-md mt-2 mx-20">
